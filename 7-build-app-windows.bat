...
call reportgenerator "-title:Hospitalsystem Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Hospitalsystem Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/calculatorapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/hospitalsystem/src;src/hospitalsystem/header;src/hospitalsystemapp/src;src/hospitalsystemapp/header;src/tests/utility;src/tests/hospitalsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\hospitalsystem\header "build_win\build\Release" /E
call robocopy src\hospitalsystemapp\header "build_win\build\Release" /E
...
call robocopy src\hospitalsystem\header "build_win\build\Debug" /E
call robocopy src\hospitalsystemapp\header "build_win\build\Debug" /E
