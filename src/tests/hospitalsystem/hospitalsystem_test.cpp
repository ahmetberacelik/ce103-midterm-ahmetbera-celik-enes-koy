...
TEST(WriteApostropheTest, Test1) {
    ...
    EXPECT_EQ(write_apostrophe(), 0);  // Replace expected_value with the expected result
}
...
TEST(LoginTest, Test2) {
    ...
    // For example, you might want to check if the login is successful
    // based on your implementation
    EXPECT_EQ(login(), 0); // Replace expected_value with the expected result
}
...
TEST(PatientRegistrationTest, Test3) {
    ...
    // based on your implementation
    EXPECT_EQ(patient_registration(), 0);  // Replace expected_value with the expected result
}
...
TEST(PatientMenuTest, Test4) {
    ...
    // For example, you might want to check if the registration is successful
    // based on your implementation
    EXPECT_EQ(patient_menu(), 0);  // Replace expected_value with the expected result
}

// Test for the patient registration function
// Test for the patient registration function
TEST(AppointmentSchedulingTest, Test5) {
    // Simulate a patient registration and check the result
    // For example, you might want to check if the registration is successful
    // based on your implementation
    EXPECT_EQ(appointment_scheduling(), 0);  // Replace expected_value with the expected result
}
...
TEST(PatientManagementTest, Test6) {
    ...
    // based on your implementation
    EXPECT_EQ(patient_management(), 0);  // Replace expected_value with the expected result
}
...
TEST(StaffManagementTest, Test7) {
    ...
    // based on your implementation
    EXPECT_EQ(staff_management(), 0);  // Replace expected_value with the expected result
}
...
TEST(IntegrationsTest, Test8) {
    ...
    // based on your implementation
    EXPECT_EQ(integrations(), 0);  // Replace expected_value with the expected result
}
...
TEST(DoctorMenuTest, Test9) {
    ...
    // based on your implementation
    EXPECT_EQ(doctor_menu(), 0);  // Replace expected_value with the expected result
}
...
TEST(PrescriptionManagementTest, Test10) {
    ...
    // based on your implementation
    EXPECT_EQ(prescription_management(), 0);  // Replace expected_value with the expected result
}
...
TEST(PatientProgressTrackingTest, Test11) {
    ...
    // based on your implementation
    EXPECT_EQ(patient_progress_tracking(), 0);  // Replace expected_value with the expected result
}
