...
// Function to display a line of dashes as a separator
...
int login() {
  while (true) {
    ...
    if (!(cin >> user_type)) {
      ...
      // Function call to display a line separator
      write_apostrophe();
      // Go back to the beginning of the loop to wait for valid input
      continue;
    }
    ...
    if (user_type == 1) {
      ...
      patient_menu(); // Exit the loop, ending the process
      break;
    } else {
      // Function call to display a line separator
      write_apostrophe();
...
int patient_registration() {
  ...
  // Store the entered patient name in the 'informations' structure or class
  ...
  // Store the entered patient medical history in the 'informations' structure or class
  ...
  while (true) {
    ...
    switch (patient_menu_selection) {
      ...
      case 2:
        ...
        patient_management();
        // Continue to display the patient menu after patient management
        continue;

      case 3:
        // Function call to handle staff management
        staff_management();
        // Continue to display the patient menu after staff management
        continue;

      case 4:
        // Function call to handle integrations
        integrations();
        // Continue to display the patient menu after integrations
        continue;
  ...
  while (true) {
    ...
    switch (apointment_scheduling_menu) {
      case 1:
        ...
        write_apostrophe(); // Function call to display a line separator
      ...
      case 3:
        ...
        write_apostrophe(); // Function call to display a line separator
        cin.ignore(); // Ignores a character input (waits for user action)
        cout << "Please select a session.\n"; // Prompts the user to select a session
        ...
        switch (surgery_no) {
          ...
          case 2:
            ...
            cout << informations.patient_treatment_session[1]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block
          ...
          case 3:
            ...
            cout << informations.patient_treatment_session[2]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block
          ...
          case 4:
            ...
            cout << informations.patient_treatment_session[3]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block
          ...
          case 5:
            ...
            cout << informations.patient_treatment_session[4]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block
          ...
          case 6:
            ...
            cout << informations.patient_treatment_session[5]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block

          case 7: // For session number 7, updates and displays the patient's treatment session
            write_apostrophe(); // Function call to display a line separator
            cout << "Yout took session number 7...\n";
            informations.patient_treatment_session[6] = "(Session 7) --> " + informations.doc[3] + " --> Monday (08:30-12:00)\n";
            cout << informations.patient_treatment_session[6]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block

          case 8: // For session number 8, updates and displays the patient's treatment session
            write_apostrophe(); // Function call to display a line separator
            ...
            cout << informations.patient_treatment_session[7]; // Displays the selected treatment session
            write_apostrophe(); // Function call to display a line separator
            break; // Exit the switch block

          default:
            write_apostrophe(); // Function call to display a line separator
            cout << "You've entered wrong session number. Please try again...\n"; // Informs about the wrong session selection
            continue; // Continues the loop, allowing the user to select another action
        }
      ...
      case 4:
        ...
        if (informations.patient_treatment_session[0].empty() && informations.patient_treatment_session[1].empty()
          ...
          if (!(cin >> delete_session)) {
            ...
            cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
            // Ignore and discard the invalid input up to the maximum buffer size or newline character
            write_apostrophe(); // Function call to display a line separato
            cout << "Invalid input. Please enter a number.\n"; // Informs the user about invalid input
            continue; // Continues the loop, allowing the user to select another action
          }
          ...
          switch (delete_session) {
            ...
            case 1:
              ...
              // Check if the session to be deleted is already empty
              if (informations.patient_treatment_session[0].empty()) {
                // Informs the user if the selected session is empty (does not exist)
                write_apostrophe();
                cout << "You made a mistake. The session that you selected is not exist.\n";
                continue; // Continues the loop, allowing the user to select another action
              } else {
                // If the session exists, delete it and inform the user
            ...
            default:
              // If the selected session number is not in the range 1-8
              write_apostrophe();
              cout << "You made a mistake. The session that you selected is not exist.\n";
              continue;
          }
  ...
  while (true) {
    ...
    switch (patient_management_menu) {
      case 1:
        ...
        cin.ignore();
        // Read the entire line (including spaces) for the new name
        getline(cin, changed_patient_name);
        // Update the patient's name with the new input
        informations.patient_name = changed_patient_name;
        // Prompt user to enter new medical history
        cout << "Please enter new medical histroy: \n";
        // Read the entire line (including spaces) for the new medical history
        getline(cin, changed_medical_history);
        // Update the patient's medical history with the new input
        ...
        write_apostrophe();
        // Continue the loop to allow further actions in the patient management menu
        continue;
      ...
      case 2:
        ...
        if (delete_check == "Delete Registration") {
          ...
          continue; // If the user decides not to delete, continue the loop for further actions
        }

        break;

      case 3:
        // Display the patient's name and medical history
        write_apostrophe();
...
int staff_management() {
  ...
  while (true) {
    // Displaying the staff management menu
    write_apostrophe();
    ...
    switch (staff_management_number) {
      case 1:
        ...
        // Display doctor schedules for different days
        cout << informations.doc[0] << " --> Monday (10:30-12:00)(Avaiable)		Thursday (13:00-16:30)(Avaiable)\n";
        cout << informations.doc[1] << " --> Wednesday (09:30-11:00)(Avaiable)	                Friday (09:00-13:30)(Avaiable)\n";
        cout << informations.doc[2] << " --> Tuesday (10:30-12:00)(Avaiable)		Wednesday (13:00-15:00)(Avaiable)\n";
        cout << informations.doc[3] << " --> Monday (08:30-12:00)(Avaiable)		        Thursday (08:00-11:00)(Avaiable)\n";
        write_apostrophe();
        write_apostrophe();
        // Display nurse schedules
        cout << "Nurse Schedules:\n";
        // Display nurse schedules for different days
        ...
        // Continue the loop for staff management
        continue;

      case 2:
        // Display doctor specializations and related information
        write_apostrophe();
      ...
      case 3:
        // Display staff training records with details
        write_apostrophe();
...
int integrations() {
  while (true) {
    ...
    if (integrations_menu == 1) {
      // Write a decorative or structural character, assuming this is the purpose of `write_apostrophe()`
      write_apostrophe();

      // Check if the third element of the drug features array is not empty (assuming 0-based indexing)
      if (!(informations.drug_features[2].empty())) {
        // Display active medications in the prescription if available
        cout << "Active medications in your prescription: " << informations.drug_features[2] << "\n";
      } else {
        // Inform the user if there are no drug records or active medications
        cout << "There is no drug record that you have...\n";
        cout << "To have active medication, you must have a doctor's prescription.\n";
      }

      // Continue the loop to present the integrations menu again
      continue;
    } else if (integrations_menu == 2) {
      // Write a decorative or structural character, assuming this is the purpose of `write_apostrophe()`
      write_apostrophe();
      // Display a welcome message for the telehealth platform and list common health issues
      ...
      // Exit the integrations menu if option 3 is selected
      break;
    } else {
      // Handle incorrect option selection by displaying an error message
      write_apostrophe();
      cout << "You've entered wrong option number. Please try again...\n";
      continue;
    }
...
int doctor_menu() {
  // Displaying the Doctor System menu with available actions
  while (true) {
    write_apostrophe();
    cout << "DOCTOR SYSTEM\n";
    ...
    // Doctor selects an action within the Medical Records menu
      ...
      while (true) {
        ...
        switch (records_number) {
          ...
          case 2:
            ...
            continue; // Continue the loop for Medical Records menu

          case 3:
            break; // Exit the loop for Medical Records menu

          default:
            write_apostrophe();
            cout << "You've entered wrong option number. Please try again...\n";
            continue; // Ask for input again in case of an invalid option
        }

        break;
      }
    } else if (doctor_menu_selection == 2) {
      login(); // Calls the login function for switching user
      break; // Exit the loop to switch user
    } else if (doctor_menu_selection == 3) {
      break; // Exit the main Doctor System loop
    } else {
      cout << "You've entered wrong option number. Please try again...\n";
      continue; // Ask for input again in case of an invalid option
    }
  ...
  return 0; // Exit the Doctor System menu function
}
  ...
  while (true) {
    ...
    switch (prescription_menu_number) {
      ...
      case 2:
        ...
        cout << "Patients:\n" << informations.default_patient_names[0] << "\n" << informations.default_patient_names[1] << "\n" << informations.patient_name << "\n";
        write_apostrophe();
        // Prompting the user to input the patient's name whose prescription needs to be cleaned
        ...
        // Checking if the entered patient's name matches any of the available patient names
        if (patient_prescription == informations.default_patient_names[0]) {
          // Cleaning the prescription for the first default patient
          informations.drug_features[0] = "";
          cout << "Prescription has been cleaned!\n";
          continue;
        } else if (patient_prescription == informations.default_patient_names[1]) {
          // Cleaning the prescription for the second default patient
          informations.drug_features[1] = "";
          cout << "Prescription has been cleaned!\n";
          continue;
        } else if (patient_prescription == informations.patient_name) {
          // Cleaning the prescription for the current patient
      ...
      case 3:
        // Displaying the list of available patients including default patients and the current patient
        write_apostrophe();
        cout << "Patients:\n" << informations.default_patient_names[0] << "\n" << informations.default_patient_names[1] << "\n" << informations.patient_name << "\n";
        write_apostrophe();
        // Prompting the user to input the patient's name whose prescription they want to know
        cout << "Which patient's prescription do you want to know ? Please write his/her name.\n";
        cin.ignore();
        getline(cin, patient_prescription);

        // Checking if the entered patient's name matches any of the available patient names and if they have a prescription
        if (patient_prescription == informations.default_patient_names[0] && !(informations.drug_features[0].empty())) {
          // Displaying the prescription for the first default patient if it exists
          write_apostrophe();
          ...
          // Displaying the prescription for the second default patient if it exists
          write_apostrophe();
          ...
          // Displaying the prescription for the current patient if it exists
          write_apostrophe();
          cout << informations.patient_name << "'s prescription is:\n" << informations.drug_features[2] << "\n";
          write_apostrophe();
          continue;
        } else {
          // Displaying an error message for an incorrect patient name entry or if the selected patient has no prescription
          write_apostrophe();
      ...
      case 4:
        // Exiting the Prescription Management system when the user selects the option to exit
        break;

      default:
        // Displaying an error message for an invalid option selected by the user and prompting them to try again
        write_apostrophe();
        cout << "You've entered wrong option number. Please try again...\n";
        continue;
    }
