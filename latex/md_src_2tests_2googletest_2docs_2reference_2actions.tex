...
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions}{}\label{md_src_2tests_2googletest_2docs_2reference_2actions}\index{Actions Reference@{Actions Reference}}
\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md239}%
\Hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md239}%
 \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ {\bfseries{Actions}}}} specify what a mock function should do when invoked. This page lists the built-\/in actions provided by Google\+Test. All actions are defined in the {\ttfamily \+::testing} namespace.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md240}{}\doxysection{\texorpdfstring{Returning a Value}{Returning a Value}}\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md240}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md241}{}\doxysection{\texorpdfstring{Side Effects}{Side Effects}}\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md241}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md242}{}\doxysection{\texorpdfstring{Using a Function, Functor, or Lambda as an Action}{Using a Function, Functor, or Lambda as an Action}}\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md242}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string("{}\+Hi"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md243}{}\doxysection{\texorpdfstring{Default Action}{Default Action}}\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md243}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md244}{}\doxysection{\texorpdfstring{Composite Actions}{Composite Actions}}\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md244}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md245}{}\doxysection{\texorpdfstring{Defining Actions}{Defining Actions}}\label{md_src_2tests_2googletest_2docs_2reference_2actions_autotoc_md245}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
