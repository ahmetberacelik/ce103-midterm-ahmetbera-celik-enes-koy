...
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers}{}\label{md_src_2tests_2googletest_2docs_2reference_2matchers}\index{Matchers Reference@{Matchers Reference}}
\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md247}%
\Hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md247}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md248}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md248}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md249}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md249}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_FpMatchers}{}\doxysection{\texorpdfstring{Floating-\/\+Point Matchers}{Floating-Point Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md250}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md250}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md251}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md251}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T\texorpdfstring{$\ast$}{*} buffer,         int len)} -- see \doxysectlink{md_src_2tests_2googletest_2docs_2reference_2matchers_MultiArgMatchers}{Multi-\/argument Matchers}{1}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md252}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md252}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md253}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md253}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md254}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md254}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_MultiArgMatchers}{}\doxysection{\texorpdfstring{Multi-\/argument Matchers}{Multi-argument Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md255}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md255}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md256}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md256}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_MatchersAsPredicatesCheat}{}\doxysection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md257}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_src_2tests_2googletest_2docs_2reference_2matchers_autotoc_md257}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
